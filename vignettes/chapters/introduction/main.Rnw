...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{conceptual_figure}
\caption{\label{fig:intro-conceptual-figure} Illustration of longitudinal and cross-sectional treatment effects. An common fallacy?}
\end{figure}
