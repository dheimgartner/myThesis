...
Chapter~\ref{ch:responseRateAnalysis} examined how survey response burden affects response rates, distinguishing the impacts of recruitment efforts and incentives. The burden had a more negative effect than previously anticipated. While recruitment raised overall response levels, only incentives mitigated the steep decline.
