...
\begin{figure}[htbp]
\centering
<<tw-comparison, echo=FALSE, fig=TRUE, height=4.8, width=4.8>>=
wfh_survey <-
  TUplus::participants %>%
...
\begin{figure}[htbp]
\centering
<<entropies-and-shares, echo=FALSE, fig=TRUE, height=6.75, width=7.1>>=
...
\begin{figure}[htbp]
\centering
<<disaggregate-time-use, echo=FALSE, fig=TRUE, height=8.1, width=5.9>>=
plot.it <- function() {
  op <- par(no.readonly = TRUE)
  on.exit(par(op))
  par(mfrow = c(3, 2))
...
\begin{figure}[htbp]
\centering
<<disaggregate-mobility-indicators, echo=FALSE, fig=TRUE, height=8.6, width=5.9>>=
plot.it <- function() {
  op <- par(no.readonly = TRUE)
  on.exit(par(op))
  par(mfrow = c(3, 2))
...
\begin{figure}[htbp]
\centering
<<aggregate-time-use, echo=FALSE, fig=TRUE, height=8.1, width=5.9>>=
plot.it <- function() {
  op <- par(no.readonly = TRUE)
  on.exit(par(op))
  par(mfrow = c(3, 2))
...
\begin{figure}[htbp]
\centering
<<aggregate-mobility-indicators, echo=FALSE, fig=TRUE, height=8.6, width=5.9>>=
plot.it <- function() {
  op <- par(no.readonly = TRUE)
  on.exit(par(op))
  par(mfrow = c(3, 2))
...
\begin{figure}[htbp]
\centering
<<model-km-pairs, echo=FALSE, fig=TRUE, height=6.75, width=6.75>>=
